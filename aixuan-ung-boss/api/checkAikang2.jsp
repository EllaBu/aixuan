...
<body>
	...
	<div id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li><span href="../dictionary/labelList.jsp"> 核保检查(指定体检后)</span>
		</ul>
	</div>
...
<!--#breadcrumbs-->
	<div id="page-content" class="clearfix">
		<div class="page-header position-relative crumbs-nav">
			<h1>核保检查接口测试（指定体检后）</h1>
           	<a href="../api/checkAikang1.jsp" class="color_02">核保检查</a>　
			<a  class="color_01"><strong>核保检查(指定体检后)</strong></a>　
		</div>
		<div class="row-fluid">
