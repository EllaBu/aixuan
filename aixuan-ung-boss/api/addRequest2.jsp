...
<!--#breadcrumbs-->
	<div id="page-content" class="clearfix">
		<div class="page-header position-relative crumbs-nav">
			<h1>异步模拟</h1>
           	<a  class="color_01"><strong>爱康产品推荐(老)</strong></a>　
           	<a href="../api/addRequest3.jsp" class="color_02">爱康产品推荐(新)</a>　
		</div>
		<div class="row-fluid">
			...
			success : function(data){
				if(data.getCode()!=0){
					...
					axSuccess("操作成功！",function(){
						location.href="http://ung.boss.aixbx.com/ungstd/ikangRequestList.jsp";
					});
				}
			}
		};
