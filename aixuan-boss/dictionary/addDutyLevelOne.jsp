	...
	<div id="main-content" class="clearfix">
		...
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li><a>新增一级责任项</a><span class="divider"></span>
				</li>
			</ul>
		</div>
				...
				<div class="row-fluid mar-t-15" style="width:70%;float: left;">
					<div class="span12">
						<div class="form-inline bord1dd form-add1 mar-t-15">
							...
							<div class="from-group mar-t-15">
								<label></label>
								<button class="btn btn-success mar-r-15" type="submit" id="addDutyLevelOne">添加</button>
...
<script type="text/javascript">
	...
	$("#addDutyLevelOne").click(function(){
		...
		xco.setStringValue("sys_op_log","新增一级责任项-新增："+dutyName);
		var options = {
			url : "/dic/addDuty.xco",
			data : xco,
