	...
	<div id="main-content" class="clearfix">
		...
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>产品拆解<span class="divider"></span></li>
			</ul>
		</div>
			...
			<div class="row-fluid">
				...
				<div class="row-fluid mar-t-15">
					<div class="span12">
						...
						<div class="from-group mar-t-15">
							<label></label>
							<button class="btn btn-success mar-r-15" type="submit" id="save">保存</button>
...
<script type="text/javascript">
	...
	$("#save").click(function(){
		...
		xco.setIntegerValue("audit_status",0);
		xco.setStringValue("sys_op_log","保存责任项："+name);
