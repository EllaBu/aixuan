	...
	<div id="main-content" class="clearfix">
		...
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li><a href="../organization/orgScoreList.jsp">公司评分管理</a><span
					class="divider"><i class="icon-angle-right"></i> </span></li>
				<li>评分导入<span class="divider"></span></li>
			</ul>
		</div>
					...
					<div class="span12">
						<div class="form-inline bord1dd form-add1 mar-t-15">
							<div class="from-group mar-t-15">
								<label><span class="font-red">*</span>备注信息</label>
								<input type="text" class="form-control" id="updateDesc" name="updateDesc" >
							</div>
							...
							<div class="from-group mar-t-15">
								<span style="margin-left: 146px;color:red;">当前下载模板为2018年3月20号最新Excel</span><span><a href="/downOrgScoreTemplate.xco" style="margin-left:20px;">模板下载</a></span>
							</div>
						</div>
...
<script type="text/javascript">
	...
	function select1(e){
		...
		$("#form1").attr("action","/uploadOrgScoreExcel.xco?"+updateDesc);
						...
						/**/
			      		if(xco.getCode() == 0){
							...
							if(_dataList.length > 0){
				      			$("#succMsg").show();
								$("#xmlid").html("处理成功!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;导入记录条数共计："+_dataList[0].getXCOValue("data").getIntegerValue("count")+"条！");
