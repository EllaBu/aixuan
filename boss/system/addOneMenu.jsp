	...
	<div id="main-content" class="clearfix">
		...
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>新增一级菜单<span class="divider"></span>
				</li>
			</ul>
		</div>
				...
				<div class="row-fluid mar-t-15" style="width:70%;float: left;">
					<div class="span12">
						<div class="form-inline bord1dd form-add1 mar-t-15">
							...
							<div class="from-group mar-t-15">
								<label></label>
								<button class="btn btn-success mar-r-15" type="submit" id="addOneMenu">添加</button>
...
<script type="text/javascript">
	...
	$("#addOneMenu").click(function(){
		...
		if(menuIcon){
			xco.setStringValue("menu_icon",menuIcon);
		}else{
			axError("请输入菜单图标");
			return;
		}
		...
		xco.setIntegerValue("menu_level",1);
		xco.setStringValue("sys_op_log","新增一级菜单-新增："+menuName);
		var options = {
