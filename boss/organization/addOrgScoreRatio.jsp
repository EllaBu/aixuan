		...
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li><a href="../organization/orgScoreRatioList.jsp">评分配比</a><span
					class="divider"><i class="icon-angle-right"></i> </span></li>
				<li>新增评分<span class="divider"></span></li>
			</ul>
		</div>
					...
					<div class="span12">
						<div class="form-inline bord1dd form-add1 mar-t-15">
							<div class="from-group mar-t-15">
								<label><span class="font-red">*</span>产品类型</label>
							...
							<div class="from-group mar-t-15"
								...
								<label></label>
								<button class="btn btn-success mar-r-15" type="submit"id="addScoreRatio">添加</button>
...
<script type="text/javascript">
	...
	$("#addScoreRatio").click(function(){
		...
		dataXco.setStringValue("sys_op_log","新增产品二级分类配比项占比-新增："+$("#twoLevelSeries").val());
		dataXco.setXCOListValue("xcolist", dataList);
		
		var options = {
			url : "/org/addOrgScoreRatio.xco",
			data : dataXco,
