...
<body>
	...
	<div id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li><span>新增选项</span><span class="divider"></span></li>
		</ul>
	</div>
...
<!--#breadcrumbs-->
	<div id="page-content" class="clearfix">
		<div class="page-header position-relative crumbs-nav">
			<h1><i class="icon-plus"></i><span>新增 </span>&nbsp;&nbsp;<span id="series_name"></span>-[<span id="oc_type"></span>]<span id="oc_name"></span></h1>
		</div>
		<div class="row-fluid">
				<div class="row-fluid">
					<div class="span12">
...
<script type="text/javascript">
	...
	$("#add").click(function(){
		...
		if(oc_score_type ==1){
			xco.setStringValue("sys_op_log","新增责任分选项-："+ov_name);
		}else{
			xco.setStringValue("sys_op_log","新增病种分选项-："+ov_name);
		}			
		xco.setIntegerValue("oc_id", oc_id);
		var options = {
			url : "/grade/insertGOptionValue.xco",
			data : xco,
